...
using Lykke.Job.IcoEthTransactionTracker.Core.Settings;
...
namespace Lykke.Job.IcoEthTransactionTracker
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "IcoEthTransactionTracker API");
                });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("IcoEthTransactionTracker", ex => new ErrorResponse {ErrorMessage = "Technical problem"});
